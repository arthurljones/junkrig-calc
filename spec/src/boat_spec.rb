...
RSpec.describe Boat do
  ...
  context "with a 35ft, 5ton sailboat" do
    ...
    its(:estimated_max_righting_moment) { is_expected.to be_within(delta "in*lbf").of "3.3e5 in*lbf" }
    ...
    context "with a specified max_buoyancy_lever" do
      ...
      its(:estimated_max_righting_moment) { is_expected.to be_within(delta "in*lbf").of "1.8e5 in*lbf" }
    end
  end
end
