...
RSpec.describe Boat do
  ...
  context "with a 35ft, 5ton sailboat" do
    ...
    its(:screening_stability_value) { is_expected.to be_within(0.01).of 22.46 }
    ...
    its(:buoyancy_lever) { is_expected.to be_within(delta "in").of "2.75 ft" }
    ...
    context "with a specified buoyancy_lever" do
      subject! { default_boat(:buoyancy_lever => "18 in") }
      its(:buoyancy_lever) { is_expected.to eq "18 in" }
